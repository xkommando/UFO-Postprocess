...
public class SimpleSolver implements UfoSolver {
  ...
  protected SimpleReachEngine reachEngine;
  ...
  public void declareVariables(ArrayList<AbstractNode> trace) {
    ...
    reachEngine = new SimpleReachEngine();
  }
  ...
  public void setReachEngine(SimpleReachEngine reachEngine) {
  ...
  public void buildSyncConstr(Indexer index) {
    ...
    ArrayList<TStartNode> thrStartNodeList = index.getThrStartNodeList();
    ...
    ArrayList<TJoinNode> joinNodeList = index.getJoinNodeList();
  ...
  public IntArrayList searchUafSchedule(Pair<DeallocNode, MemAccNode> p) {
    return searchUafSchedule(true, p);
  }

  public IntArrayList searchUafSchedule(boolean doSolve, Pair<DeallocNode, MemAccNode> p) {
   ...
   currentIndexer.getTSDependentSeqRead(allReadNodes, accNode);
    ...
    IntArrayList ls =  task.buildSchedule(csb);
    return ls;
  }
