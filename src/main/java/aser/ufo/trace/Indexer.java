...
//  }
    ...
    ArrayList<TStartNode> thrStartNodeList = new ArrayList<TStartNode>(UFO.INITSZ_S * 5);
    ArrayList<TJoinNode> joinNodeList = new ArrayList<TJoinNode>(UFO.INITSZ_S * 5);
    ...
    public ArrayList<TStartNode> getThrStartNodeList() {
      return thrStartNodeList;
    }

    public ArrayList<TJoinNode> getJoinNodeList() {
      return joinNodeList;
    }
...
//    info.incrementSyncNumber();
    ...
    protected Int2ObjectOpenHashMap<AbstractNode> gid2node;

    public Int2ObjectOpenHashMap<AbstractNode> getGid2node() {
      return gid2node;
    }
    ...
    public void prepareNorm() {
      ...
      shared.destroy();
      System.gc();
      gid2node = new Int2ObjectOpenHashMap<AbstractNode>(UFO.INITSZ_L * 2);
...
//    throw new RuntimeException("Not implemented");
    ...
    public SimpleReachEngine getReachEngine() {
      return reachEngine;
    }
